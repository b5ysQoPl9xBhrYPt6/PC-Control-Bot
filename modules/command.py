from .bot_settings import bot, dp, file_system_menu_memory
...
async def main_message(message: Message, state: FSMContext):
    ...
    action_lock_keyboard = KeyboardButton(text='Заблокировать или разблокировать клавиатуру')
